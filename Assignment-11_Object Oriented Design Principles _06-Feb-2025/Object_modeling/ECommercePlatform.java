...
class ECommercePlatform {
    public static void main(String[] args) {
        // Creating products
        Product product1 = new Product("Laptop", 51000.99);
        Product product2 = new Product("Smartphone", 12999.99);
        Product product3 = new Product("Headphones", 1999.99);

        // Creating a customer
        Customer1 customer1 = new Customer1("Akshat");

        // Creating an order
        Order order1 = new Order(151, customer1);
        order1.addProduct(product1);
        order1.addProduct(product2);

        // Creating another order
        Order order2 = new Order(161, customer1);
