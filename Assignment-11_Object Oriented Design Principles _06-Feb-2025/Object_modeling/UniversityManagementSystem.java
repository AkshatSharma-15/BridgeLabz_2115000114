...
public class UniversityManagementSystem {
    public static void main(String[] args) {
        // Creating students
        Student1 student1 = new Student1("Akshat");
        Student1 student2 = new Student1("Aman");

        // Creating professors
        Professor professor1 = new Professor("Dr. Raj");
        Professor professor2 = new Professor("Dr. Raju");
