...
public class BankSystem {
    public static void main(String[] args) {
        ...
        Customer customer1 = new Customer("Akshat");
        Customer customer2 = new Customer("Aman");


        bank1.openAccount(customer1, 2000);
        bank2.openAccount(customer1, 1800);
        bank1.openAccount(customer2, 3500);
        bank3.openAccount(customer2,5000);
